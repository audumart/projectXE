        ...
        <div class="brand-bg">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                     ...
                     <li><a href="adminhome.php">Home</a></li>
                         <li><a href="addmembers.php">Manage members</a></li>
...
<div class="row">
    <div class="col-md-6 col-sm-12 col-xs-12">
        <div class="header-details">
            <h1>Hello Admin you can view and edit the available services here<i class="fa fa-circle"></i></h1>
        </div>
    </div>
</div>
</div>
...
<section id="promotion-area" class="sections">
    ...
    <div class="col-sm-4 col-sm-12 col-xs-12">
        ...
        <p>Managing your website better</p>
    ...
    <div class="col-sm-4 col-sm-12 col-xs-12">
        ...
        <h1>Better<br>Management<i class="fa fa-circle"></i></h1>
        <p>Don't overtweak this section too much</p>
